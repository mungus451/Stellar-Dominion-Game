...
$upgrades = [
    'fortifications' => [
        ...
        'levels' => [
            1 => ['name' => 'Foundation Outpost', 'cost' => 50000000, 'level_req' => 1, 'bonuses' => [], 'description' => 'Establishes a basic command structure.'],
            2 => ['name' => 'Planetary Base', 'cost' => 250000000, 'level_req' => 5, 'bonuses' => [], 'description' => 'A fortified base of operations.'],
            3 => ['name' => 'Orbital Station', 'cost' => 1000000000, 'level_req' => 10, 'bonuses' => [], 'description' => 'Extends your influence into the local system.'],
            4 => ['name' => 'Star Fortress', 'cost' => 5000000000, 'level_req' => 15, 'bonuses' => [], 'description' => 'A bastion of your military and economic power.'],
            5 => ['name' => 'Galactic Citadel', 'cost' => 20000000000, 'level_req' => 20, 'bonuses' => [], 'description' => 'The unshakable heart of your growing empire.'],
        ]
    ],
    'armory' => [
        ...
        'levels' => [
            1 => ['name' => 'Armory Level 1', 'cost' => 500000000, 'fort_req' => 2, 'bonuses' => [], 'description' => 'Unlocks Tier 2 weapon schematics.'],
            2 => ['name' => 'Armory Level 2', 'cost' => 2500000000, 'fort_req' => 3, 'bonuses' => [], 'description' => 'Unlocks Tier 3 weapon schematics.'],
            3 => ['name' => 'Armory Level 3', 'cost' => 10000000000, 'fort_req' => 4, 'bonuses' => [], 'description' => 'Unlocks Tier 4 weapon schematics.'],
            4 => ['name' => 'Armory Level 4', 'cost' => 40000000000, 'fort_req' => 5, 'bonuses' => [], 'description' => 'Unlocks Tier 5 weapon schematics.'],
            5 => ['name' => 'Armory Level 5', 'cost' => 100000000000, 'fort_req' => 5, 'bonuses' => [], 'description' => 'Unlocks experimental and masterwork weapons.'],
        ]
    ],
    'offense' => [
        ...
        'levels' => [
            1 => ['name' => 'Enhanced Targeting I', 'cost' => 150000000, 'fort_req' => 1, 'bonuses' => ['offense' => 5], 'description' => '+5% Offense Power.'],
            2 => ['name' => 'Enhanced Targeting II', 'cost' => 750000000, 'fort_req' => 2, 'bonuses' => ['offense' => 5], 'description' => '+5% Offense Power (Total: 10%).'],
            3 => ['name' => 'Enhanced Targeting III', 'cost' => 3000000000, 'fort_req' => 3, 'bonuses' => ['offense' => 10], 'description' => '+10% Offense Power (Total: 20%).'],
        ]
    ],
    'defense' => [
        ...
        'levels' => [
            1 => ['name' => 'Improved Armor I', 'cost' => 150000000, 'fort_req' => 1, 'bonuses' => ['defense' => 5], 'description' => '+5% Defense Rating.'],
            2 => ['name' => 'Improved Armor II', 'cost' => 750000000, 'fort_req' => 2, 'bonuses' => ['defense' => 5], 'description' => '+5% Defense Rating (Total: 10%).'],
            3 => ['name' => 'Improved Armor III', 'cost' => 3000000000, 'fort_req' => 3, 'bonuses' => ['defense' => 10], 'description' => '+10% Defense Rating (Total: 20%).'],
        ]
    ],
    'economy' => [
        ...
        'levels' => [
            1 => ['name' => 'Trade Hub I', 'cost' => 200000000, 'fort_req' => 1, 'bonuses' => ['income' => 5], 'description' => '+5% to all credit income.'],
            2 => ['name' => 'Trade Hub II', 'cost' => 1000000000, 'fort_req' => 2, 'bonuses' => ['income' => 5], 'description' => '+5% credit income (Total: 10%).'],
            3 => ['name' => 'Trade Hub III', 'cost' => 4000000000, 'fort_req' => 3, 'bonuses' => ['income' => 10], 'description' => '+10% credit income (Total: 20%).'],
        ]
    ],
    'population' => [
        ...
        'levels' => [
            1 => ['name' => 'Habitation Pods I', 'cost' => 300000000, 'fort_req' => 1, 'bonuses' => ['citizens' => 1], 'description' => '+1 citizen per turn (Total: 2).'],
            2 => ['name' => 'Habitation Pods II', 'cost' => 1500000000, 'fort_req' => 2, 'bonuses' => ['citizens' => 1], 'description' => '+1 citizen per turn (Total: 3).'],
            3 => ['name' => 'Habitation Pods III', 'cost' => 6000000000, 'fort_req' => 4, 'bonuses' => ['citizens' => 2], 'description' => '+2 citizens per turn (Total: 5).'],
        ]
    ],
];
