...
$sql_fetch = "SELECT character_name, email, biography, avatar_path, credits, untrained_citizens, level, attack_turns, last_updated FROM users WHERE id = ?";
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 p-4">
                <aside class="lg:col-span-1 space-y-4">
                    <?php 
                        ...
                        $user_xp = 0; // Profile page doesn't show XP, so we can default to 0
                        ...
                        <ul class="space-y-2 text-sm">
                            ...
                            <li class="flex justify-between border-t border-gray-600 pt-2 mt-2">
                             ...
                             <li class="flex justify-between">
                                ...
                                <span class="text-white font-semibold"><?php echo $now->format('H:i:s'); ?></span>
                            </li>
                        </ul>
                    </div>
                </aside>
