                    ...
                    <tr>
                        ...
                        <td class="px-3 py-3">
                            <div class="flex items-center justify-end gap-2">
                                <!-- Intelligence (default, 1–10 turns) -->
                                ...
                                <!-- Assassination quick launcher (target chosen on report page) -->
                                <form action="/spy.php" method="POST" class="hidden lg:flex items-center gap-1">
                                    ...
                                    <input type="hidden" name="assassination_target" value="soldiers">
                                    <input type="hidden" name="defender_id" value="<?php echo (int)$t['id']; ?>">
                                    <input type="number" name="attack_turns" min="1" max="10" value="1" class="w-12 bg-gray-900 border border-gray-600 rounded text-center p-1 text-xs">
                                    <button type="submit" class="bg-red-700 hover:bg-red-600 text-white text-xs font-semibold py-1 px-2 rounded-md">Assassinate</button>
                                </form>
