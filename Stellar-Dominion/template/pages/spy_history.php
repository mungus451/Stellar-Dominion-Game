 ...
 * spy_history.php
 *
 * This page displays a unified, sortable, and paginated spy mission history for the player.
 */
...
$sql_select = "
    SELECT 
        sl.id, sl.attacker_id, sl.defender_id, sl.outcome, sl.mission_type, sl.mission_time,
        att.character_name AS attacker_name, 
        def.character_name AS defender_name,
        CASE WHEN sl.attacker_id = ? THEN 'offense' ELSE 'defense' END AS type
    FROM spy_logs sl
...
<head>
    ...
    <title>Starlight Dominion - Spy History</title>
                ...
                <main class="lg:col-span-3 space-y-6">
                    <div class="content-box rounded-lg p-4">
                        ...
                        <?php if ($total_pages > 1):
                            // Pagination logic copied from war_history.php
                            $page_window = 10;
