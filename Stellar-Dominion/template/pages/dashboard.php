...
require_once __DIR__ . '/../includes/dashboard/vault_hydration.php';
...
<div class="lg:col-span-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
    ...
    <?php include __DIR__ . '/../includes/dashboard/vault_card.php'; ?>
...
include __DIR__ . '/../includes/dashboard/footer_scripts.php';
?>
