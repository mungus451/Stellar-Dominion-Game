...
// Timer Calculations for Next Turn (compute BEFORE including navigation)
...
<body class="text-gray-400 antialiased">
                    ...
                    <form action="" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            ...
                            <div class="content-box rounded-lg p-4">
                                ...
                                <input type="number" name="strength_points" min="0" value="0"
                                       x-model.number="s"
                            ...
                            <div class="content-box rounded-lg p-4">
                                ...
                                <input type="number" name="constitution_points" min="0" value="0"
                                       x-model.number="c"
                                       class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-2 py-1 text-white focus:outline-none focus:ring-1 focus:ring-cyan-500 point-input">
                            </div>
                            <!-- Wealth -->
                            <div class="content-box rounded-lg p-4">
                                ...
                                <input type="number" name="wealth_points" min="0" value="0"
                                       x-model.number="w"
                                       class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-2 py-1 text-white focus:outline-none focus:ring-1 focus:ring-cyan-500 point-input">
                            </div>
                            <!-- Dexterity -->
                            <div class="content-box rounded-lg p-4">
                                ...
                                <input type="number" name="dexterity_points" min="0" value="0"
                                       x-model.number="d"
                                       class="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-2 py-1 text-white focus:outline-none focus:ring-1 focus:ring-cyan-500 point-input">
                            </div>
                            <!-- Charisma -->
    ...
    <!-- Keep existing JS so no functionality is removed; Alpine handles live total too -->
    <script>
