<?php
/**
 * public/fix_all_leaders_final.php
 *
 * This is a one-time-use script to grant full permissions to all existing
 * alliance leaders by directly updating their assigned roles. This version
 * is compatible with the individual column permission schema.
 *
 * !!! IMPORTANT !!!
...
<head>
    <meta charset='UTF-8'>
    <title>Fix Alliance Leader Permissions (Final)</title>
    <style>
...
try {
    ...
    if (empty($alliances)) {
        ...
        // Prepare the SQL to update a role using individual columns
        $sql_update_role = "
    ...
    echo "<p class='warn'>!!! IMPORTANT: DELETE THIS SCRIPT (fix_all_leaders_final.php) FROM YOUR SERVER NOW. !!!</p>";
